...
|---|---:|---:|
| Attacks caught (`add_header` or `reject`) | 40/52 (76.9%) | 43/52 (82.7%) |
| Attacks at `no_action` | 12/52 (23.1%) | 9/52 (17.3%) |
| Attacks at `add_header` | 37/52 | 32/52 |

...
# Test 5: Paired deletion of attack fixture (authoritative count 65 != 66)
...
# Test 9: Paired deletion of legitimate fixture (authoritative count 65 != 66)
